...
- On the other hand, words about some topics often appears in specific documents, so that they can get more weight because they're likely to implicit topics the documents have.
...
- Eventually, we selected E5 model, as the state-of-the-art model by Microsoft, to verify quality of the knowledge base and performance of the retriever in a military regulation domain.
...
- We're gonna deal with this issue in conclusion later soon.
...
- And then, removing 476 articles deleted by revisions before, we can now utilize 9,903 articles, in which the retriever can find query-related articles.
...
- 1,000 pairs were made manually by 3 people for about 2 weeks, including declarative and imperative sentences as well as interrogative sentences.
